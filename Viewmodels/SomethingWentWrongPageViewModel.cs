...
namespace FireSignage.ViewModels
{
    ...
    public class SomethingWentWrongPageViewModel : BaseViewModel
    {
        ...
        private static SomethingWentWrongPageViewModel somethingWentWrongPageViewModel;
        ...
        /// </summary>
        public static SomethingWentWrongPageViewModel BindingContext =>
            somethingWentWrongPageViewModel = PopulateData<SomethingWentWrongPageViewModel>("errorAndEmpty.json");
